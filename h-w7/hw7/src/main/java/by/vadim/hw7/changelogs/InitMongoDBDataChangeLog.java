...
import by.vadim.hw7.repositories.AuthorRepository;
import by.vadim.hw7.repositories.BookRepository;
...
public class InitMongoDBDataChangeLog {
    ...
    public void initAuthors(AuthorRepository authorRepository){
        ...
        aut3Author = authorRepository.save(new Author("Есенин С.А."));
